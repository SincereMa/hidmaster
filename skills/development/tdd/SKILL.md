...
prerequisites:
  - Clear requirements or bug description
...
**Related skills:**
- **debug** — Bug found? Write failing test reproducing it. Follow TDD cycle.
- **validate** — Verify fix worked before claiming success.
- **refactor** — Only refactor when tests are green.
